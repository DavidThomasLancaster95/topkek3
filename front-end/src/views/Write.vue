  ...
  <div class="admin">
    ...
    <div class="edit">
      ...
      <div class="upload" v-if="findItem">
        <p>Edit Title of Meme</p>
        <input v-model="findItem.title" />
        <p></p>
        <p>Edit Week of Meme</p>
        <textarea v-model="findItem.description" placeholder="Replace descirption here!"/>
        <p></p>
    ...
    async editItem(item) {
      try {
        if (this.findItem.description > this.$root.$data.topWeek) {
          alert('woah, you can"t go forward that far\nPlease choose a week between 1 and ' + this.$root.$data.topWeek);
          throw("exceed bounds");
        }
